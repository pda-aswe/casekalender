...
class TestappointmentManager(unittest.TestCase):
    ...
    def test_extract_information_from_text_new_appointment(self):
        ...
        assert appointmentManager.extract_information_from_text_new_appointment(text) == ("2023-04-21T12:00:00+00:00", "2023-04-21T14:00:00+00:00", "Test") or appointmentManager.extract_information_from_text_new_appointment(text) == ("2024-04-14T12:00:00+00:00", "2024-04-14T14:00:00+00:00", "Test")
